...
Du hast einen Ordner auf deinem Telefon. Vielleicht hast du ihn irgendwo auf dem zweiten oder dritten Bildschirm versteckt. Er ist voll mit Apps — Task Manager, Planer, Gewohnheits-Tracker — die alle gleich anfangen und gleich enden: mit hoffnungsvollem Tippen und stillem Aufgeben. Jede sah vielversprechend aus. Jede fühlte sich an, als könnte es dieses Mal funktionieren. Keine hat es getan.
...
Standard-To-Do-Apps wurden um eine Reihe von Annahmen über menschliche Planung und Ausführung herum entworfen. Diese Annahmen funktionieren für eine bestimmte Art von Gehirn. Für ADHS-Gehirne wirken sie sich aktiv negativ aus.
...
**Entscheidungslähmung.** Öffne eine Aufgabenliste mit 60 Einträgen und du musst eine Entscheidung treffen, bevor du überhaupt etwas angefangen hast: Welche? Für ein Gehirn, das bereits mit der Aufgabeninitiierung kämpft, ist diese erste Entscheidung ein enormes Hindernis. Je größer die Liste, desto höher die Hürde zum Anfangen.
...
Das Problem ist, dass dieser Ansatz eine Taktik für kurzfristiges Engagement als langfristiges System behandelt. Und in der Praxis erzeugt jede dieser Funktionen ihre eigene Art von Reibung.

**Streaks** sind besonders destruktiv. Ein Streak-System belohnt Konsistenz, indem es jeden Aussetzer katastrophal wirken lässt. Du verlierst deinen Streak, du hast ihn „gebrochen", du bist wieder bei Null. Für jemanden, der bereits mit einem inneren Kritiker kämpft, der jede verpasste Aufgabe als persönliches Versagen darstellt, ist ein Streak-Counter, der rot wird, nicht motivierend. Es ist das Gegenteil. Es kommt eine weitere Sache dazu, wegen der man sich schlecht fühlt, und ein weiterer Grund, die App zu meiden.

**Mehr Erinnerungen** erzeugen Benachrichtigungsmüdigkeit. Nach der dritten oder vierten Warnung für dieselbe unerledigte Aufgabe werden die Benachrichtigungen zum Hintergrundrauschen. Sie werden automatisch weggewischt und lösen keine Aktion mehr aus. Das beabsichtigte Signal ertrinkt in seiner eigenen Wiederholung.
...
**Weniger gleichzeitig sichtbare Aufgaben** bedeutet weniger Entscheidungen, bevor du anfängst. Wenn du heute drei Dinge auf deiner Liste siehst, ist die Wahl zwischen ihnen handhabbar. Wenn du vierzig siehst, ist die erste Aufgabe, diese vierzig auf drei zu reduzieren, und viele Menschen kommen über diesen Schritt nie hinaus.

**Keine Überfällig-Markierungen** bedeuten keinen Schuldauslöser. Wenn eine Aufgabe, die du gestern nicht erledigt hast, heute Morgen nicht als „fehlgeschlagen" markiert ist, wenn du die App öffnest, sinken die emotionalen Kosten des App-Öffnens erheblich. Die Aufgabe ist immer noch da, falls sie wichtig ist, aber sie bestraft dich nicht dafür, menschlich zu sein.

**Ein täglicher Reset** bedeutet, jeden Morgen neu zu entscheiden, statt einen geerbten Stapel zu übernehmen. Statt gestrige unvollendete Aufgaben als Schuld voranzutragen, schaust du auf deinen Backlog und wählst, was heute wichtig ist. Das ist eine fundamental andere Beziehung zu deiner Aufgabenliste: Es ist eine tägliche Entscheidung, keine wachsende Verpflichtung.

**Ein kleiner täglicher Fokus** schafft ein klares Erfolgssignal. „Habe ich meine drei Dinge gemacht?" ist eine Frage mit einer echten Antwort. „Habe ich Fortschritte bei meiner 47-Einträge-Liste gemacht?" ist das nicht.
...
Dieses zweite Zitat ist bedeutsam. Keine Angst, deine Aufgabenliste anzusehen. Das sollte die Basiserwartung an jedes Produktivitätswerkzeug sein, und für viele Menschen ist es das nicht.
...
Markiert sie diese als überfällig, oder lässt sie dich jeden Tag neu entscheiden? Die Antwort sagt viel über die zugrundeliegende Philosophie.

**2. Wie viele Einträge sind auf einmal in der Standard-Ansicht sichtbar?**
Eine Standard-Ansicht, die deinen gesamten Task-Verlauf zeigt, ist eine andere Design-Entscheidung als eine, die zeigt, was du für heute gewählt hast. Keine ist grundsätzlich falsch, aber eine wird besser für bestimmte Gehirne funktionieren.
...
Je niedriger die Reibung beim Hinzufügen einer Aufgabe, desto wahrscheinlicher ist es, dass du sie tatsächlich hinzufügst, wenn dir die Idee kommt. Eine App, die ein Projekt, einen Tag und ein Fälligkeitsdatum für jeden neuen Eintrag erfordert, erzeugt eine Hürde, die den Zweck der Erfassung aufhebt.
...
Der häufigste Fehler im Produktivitäts-App-Design für ADHS-Gehirne ist keine fehlende Funktion. Es ist die Anwesenheit von Funktionen, die genau die kognitive und emotionale Reibung erzeugen, die sie beheben sollten. Mehr Erinnerungen erzeugen Vermeidung. Streaks erzeugen Angst. Überfällig-Markierungen erzeugen Schuldgefühle. Komplexe Strukturen erzeugen Lähmung. Das Muster verstärkt sich, bis die App in jenem Ordner landet, neben jeder anderen, die du je ausprobiert hast.

Der Entwickler hinter Dawny hat die App gebaut, weil er ADHS hat und immer wieder gegen dieselbe Mauer lief, nicht um ein Produktivitätsprodukt zu bauen, sondern um aufzuhören, seine eigene Aufgabenliste zu fürchten. Das Resultat ist nicht eine App mit ADHS-Funktionen. Es ist eine App, bei der die üblichen Quellen von Reibung entfernt wurden. Aufgaben setzen sich zurück, statt überfällig zu werden. Die tägliche Ansicht ist bewusst klein. Nichts bestraft dich dafür, menschlich zu sein.
