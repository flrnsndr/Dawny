...
> **Kurz gesagt:** Die Methode der 3 wichtigsten Aufgaben (MIT, Most Important Tasks) fordert dich auf, jeden Morgen drei Aufgaben auszuwählen, zu deren Erledigung du dich verpflichtest — und nur drei. Diese Beschränkung zwingt zur Priorisierung, reduziert Entscheidungsmüdigkeit während des Tages und schafft ein klares Erfolgssignal: Wenn du deine drei Aufgaben schaffst, war der Tag produktiv. Alles andere ist ein Bonus.
...
**Schritt 1: Überprüfe dein Backlog kurz. Aber verliere dich nicht darin.** Scanne dein [tägliches Planungssystem](/de/blog/daily-planning-system/) oder deine Aufgabenliste, um dich an das zu erinnern, das auf dich wartet. Das ist eine Übersicht, keine tiefe Analyse. Gib dir ein Zeitlimit, maximal zwei Minuten.
...
Alles, was nicht auf deiner MIT-Liste steht, geht ins Backlog, einen separaten Wartebereich für Aufgaben, die real und gültig sind, aber nicht die Verpflichtung von heute. Das Backlog ist keine Fehlerzone. Es ist keine Liste von Dingen, die du vernachlässigst. Es ist ein Parkplatz, ein sicherer Ort für Aufgaben, bis sie auf deiner Prioritätsliste nach oben rücken oder relevant werden.
...
- Die Gliederung für die Team-Präsentation schreiben
...
Du fängst mit dem Vertrag an. Es dauert länger als erwartet: 90 Minuten statt 45. Als du ihn fertig hast, bist du wirklich stolz. Du arbeitest die Präsentationsgliederung nach dem Mittagessen durch. Um 16 Uhr merkst du, dass du den Zahnarzttermin nicht vereinbart hast. Du wirst abgelenkt, der Tag endet, und du hast es nicht geschafft.
...
Im MIT-Modell kehrt „Zahnarzt vereinbaren" zu deinem Backlog zurück. Am nächsten Morgen wählst du deine drei MITs erneut. Ist die Vereinbarung eines Zahnarzttermins eines der drei Dinge, die den morgigen Tag lohnenswert machen würden? Wahrscheinlich nicht. Aber du wirst es dann entscheiden. Wenn du es sechs weitere Male übersprungen hast, weißt du, dass es entweder nicht wichtig ist oder wichtig genug, um es endlich an erste Stelle zu setzen.

Zwei von drei MITs erledigt ist nach den meisten Maßstäben ein produktiver Tag. Die MIT-Methode gibt dir diese Rückmeldung klar. Eine Liste von 34 Aufgaben nicht.
