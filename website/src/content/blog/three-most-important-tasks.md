...
pubDate: 2026-05-10
seoKeyword: "3 most important tasks"
category: "daily-planning"
tags: ["3 most important tasks", "MIT method productivity", "most important task method", "daily priority setting", "daily planning", "decision fatigue"]
---
...
The method is most widely credited to Leo Babauta, who popularized it through his [Zen Habits blog](https://zenhabits.net) starting in the late 2000s. The core rule is straightforward: pick three MITs before you start working, write them down separately from your larger task list, and treat them as your non-negotiable commitments for the day. Everything else is optional.
...
**Why "five" often becomes "some of five."** Research on decision fatigue — the documented phenomenon where the quality of decisions deteriorates after a long sequence of choices — suggests that longer lists don't just fail to help: they actively hurt. A [2011 study published in the Proceedings of the National Academy of Sciences](https://www.pnas.org/doi/10.1073/pnas.1018033108) found that judges made worse legal decisions later in the day as their cognitive resources depleted. The same principle applies to task lists: the longer the list, the more decisions you defer, and the less likely you are to act on any of it. Five items is enough to trigger the avoidance that comes with [decision fatigue](/en/blog/decision-fatigue-task-management/).
...
1. Send the revised contract to the client (most important, most dreaded)
2. Write the outline for the team presentation
3. Schedule the dentist appointment you've been postponing for two months
